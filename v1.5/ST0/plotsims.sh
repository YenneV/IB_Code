...
timestep=$((250 * ($number + 10))) #number variable is short by 10 in this calculation each time
...
set xlabel "x " 
set xlabel "y " 
plot "$input1" u 1:2:(\$3*$vscale):(\$4*$vscale) w vectors lc 3 t '', "$input2" u 1:2pt 13 ps 1 lc rgb '#bc1abf' t ''
EOF
